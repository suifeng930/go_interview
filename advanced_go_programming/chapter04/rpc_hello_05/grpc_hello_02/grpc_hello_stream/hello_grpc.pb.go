...
type HelloServiceClient interface {
	...
	// HelloService_ChannelClient 可以用于和服务端进行双向通信
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/grpc_hello_01.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/grpc_hello_01.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
type HelloServiceServer interface {
	...
	// HelloService_ChannelServer 可以用于和客户端双向通信。
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_hello_01.HelloService/Hello",
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_hello_01.HelloService",
